...
//                pd.filename.html(fileNameStr);
        ...
        function createCutomInputFile(obj, group, s, uploadLabel) {
            ...
            var fileInputStr = "<input type='file' id='" + fileUploadId + "' name='" + s.fileName + "' onchange='return CheckExtension(this);' accept='" + "image/jpg, image/png, image/x-png, image/gif" + "'/>";
            if(s.multiple) {
...
//                        console.log("beforeSend aa 5%");
                        pd.progressbar.width('5%');
                    } else {    //Fix for small files
//                        console.log("beforeSend bb 1%");
                        pd.progressbar.width('1%');
                    } 
                },
