    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if (data.code == 0) {
                ...
                var content = "";
                content += "Question: " + data.question.voice_text + "<br>";
                content += "  Answer: " + data.answer.voice_text + "<br>";
                $("#detail_content").html(content);
                
                $("#detail_voice").attr('src', data.answer.voice_audio);
    ...
    $('#table_content').dataTable({
        ...
        "ajax": {
            ...
            data: function(d) {
                ...
                d.question_id = $("#filter_question_id").val();
        ...
        "columns": [
            ...
            },
            {
                ...
                "render": function (data, type, row, meta) {
                    ...
                    d += '<span class="label label-sm label-danger"><i class="icon md-comment-outline"></i>&nbsp; '+data+'</span>';
