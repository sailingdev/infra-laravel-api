...
function add() {
    ...
    $("#faq_dialog .modal-header .modal-title").html("Add How it works Item");
...
function edit(id) {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if (data.code == 0) {
                $("#faq_dialog .modal-header .modal-title").html("Edit How it works Item");
...
function view(id) {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if (data.code == 0) {
                $("#faq_dialog .modal-header .modal-title").html("View How it works Item");
